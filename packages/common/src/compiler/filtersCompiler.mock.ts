...
export const stringFilterRuleMocks = {
    ...
    notIncludeFilterWithSingleValSQL: `((${stringFilterDimension}) NOT LIKE '%Bob%' OR (${stringFilterDimension}) IS NULL)`,
    notIncludeFilterWithMultiVal: {
        ...stringMultiValueFilter,
        operator: FilterOperator.NOT_INCLUDE,
    },
    notIncludeFilterWithMultiValSQL: `((${stringFilterDimension}) NOT LIKE '%Tom%'\n  AND\n  (${stringFilterDimension}) NOT LIKE '%Jerry%' OR (${stringFilterDimension}) IS NULL)`,
